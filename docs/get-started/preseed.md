...
!!! note
    ...
    Debian provides [alternative preseeding methods](https://www.debian.org/releases/stable/amd64/apbs01.en.html#preseed-methods), but they won't be covered due to their complexity.
