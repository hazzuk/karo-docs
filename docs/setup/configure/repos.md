...
Storing your configuration using git brings many benefits. Most importantly, it makes restoring your setup after a hardware failure or a move to a new system much simpler. Additionally, you'll get the full history of any changes you commit. So you can always revert back to a previous version of your configuration if something goes wrongs.
